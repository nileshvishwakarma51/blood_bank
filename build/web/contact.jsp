                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="find-widget">
                                Company:- <a href="index.jsp">Blood Bank Management System</a>
                            </div>
                            <div class="find-widget">
                                Address:- <a href="#">SD Bansal College Of Technology</a>
                            </div>
                            <div class="find-widget">
                                Phone:- <a href="#">+91 8001317856</a>
                            </div>

                            <div class="find-widget">
                                Website:- <a href="index.jsp">www.bloodbank.com</a>
                            </div>
                            <div class="find-widget">
                                Timing:- <a href="#">Mon to Sat: 10:30 AM - 08.30 PM</a>
                            </div>
                        </div>
                        <!-- contact form -->
                            ...
                            <form class="shake" role="form" method="post" id="contactForm"
                                ...
                                <div class="form-group label-floating">
                                    <label class="control-label" for="name">Name</label> <input
                                        class="form-control" id="name" type="text" name="name" required
                        ...
                        <style>
                            ...
                            .form-control, .form-group .form-control {
                                ...
                                background-image: -webkit-gradient(linear, left top, left bottom, from(#009688),
                                    to(#009688)),
                                    -webkit-gradient(linear, left top, left bottom, from(#D2D2D2),
                                    to(#D2D2D2));
                            ...
                            .form-control[disabled], .form-control[readonly], .form-group .form-control[disabled],
                            .form-group .form-control[readonly], fieldset[disabled] .form-control,
                            ...
                            .form-group.has-warning.is-focused .form-control {
                                background-image: -webkit-gradient(linear, left top, left bottom, from(#ff5722),
                                    to(#ff5722)),
                                    -webkit-gradient(linear, left top, left bottom, from(#D2D2D2),
                                    to(#D2D2D2));
                            ...
                            .form-group.has-success.is-focused .form-control {
                                background-image: -webkit-gradient(linear, left top, left bottom, from(#4caf50),
                                    to(#4caf50)),
                                    -webkit-gradient(linear, left top, left bottom, from(#D2D2D2),
                                    to(#D2D2D2));
                            ...
                            .form-group.has-info.is-focused .form-control {
                                background-image: -webkit-gradient(linear, left top, left bottom, from(#03a9f4),
                                    to(#03a9f4)),
                                    -webkit-gradient(linear, left top, left bottom, from(#D2D2D2),
                                    to(#D2D2D2));
                            ...
                            .form-group.form-group-sm .checkbox label, .form-group.form-group-sm .radio label,
                            ...
                            .form-group.form-group-sm.label-floating input.form-control:-webkit-autofill
                            ...
                            .form-group.form-group-lg.label-floating input.form-control:-webkit-autofill
                            ~label.control-label label.control-label {
                                top: -32px;
                                left: 0;
                                font-size: 14px;
